...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 20 17:40:16 2021
...
Locations = {}#'B61':,'B62':,'B71':,'B7-AVG':,'B81':,'B82':,'B83':,'B8-AVG':,'C1':,'C2':,'C - AVG':,'G1':,'G2':,'G3':,'G-AVG':,'SH1':,'SY1':,'SY2':,'SY3':,'SY4':,'SY-AVG':}
Locations['Date'] = 'Date' 
...
Locations['72100027FC71'] = 'B7F1' #B7F1 
